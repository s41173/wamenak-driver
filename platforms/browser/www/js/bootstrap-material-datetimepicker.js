   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<a class="dtp-btn-cancel btn-flat">' + this.params.cancelText + '</a>' +
                         '<a class="dtp-btn-clear btn-flat" hidden>' + this.params.clearText + '</a>' +
                         '<a class="dtp-btn-ok btn-flat">' + this.params.okText + '</a>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
